...
function AboutUs () {
    return(
        <div className="aboutc">
            ...
            <h1>Our Mission</h1>
            <p>Our mission is to touch the horizon where our capabilities may succesfully meet with the requirements of our clients, that too with ultimate transparency an cost-effectiveness.</p>
